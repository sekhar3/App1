...
class HolderPortal(SeleniumDriver):
    ...
    def enter_Email(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Email Method")
            raise Exception
    ...
    def enter_birthdate(self, DOB):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Date of Birth Method")
            raise Exception
    ...
    def enter_phone_number(self, phone):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Phone Number Method")
            raise Exception
    ...
    def enter_password(self, password):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Password Method")
            raise Exception
    ...
    def enter_Confirm_password(self, password):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Confirm Password Method")
            raise Exception
    ...
    def click_continue_button(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Continue Button Method")
            raise Exception
    ...
    def click_go_to_upass(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Go To U-Pass Button Method")
            raise Exception
    ...
    def verify_new_account(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Verifying New Account Method")
            raise Exception
    ...
    def click_profile_tab(self):
        try:
            ...
            element = driver.find_element_by_xpath(self.profile_btn)
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Profile Button Method")
            raise Exception
    ...
    def click_account_details_tb(self):
        try:
            ...
            element = driver.find_element_by_xpath(self.account_details_tb)
            driver.execute_script("arguments[0].click();", element)
            print("Account Details Button is clicked")
        except Exception:
            print("Exception in Clicking Account Details Method")
            self.screenshot.attach_screenshot_to_allure_report("Clicking Account Details Method")
            raise Exception
    ...
    def enter_basic_info_edit_name(self, name):
        try:
            ...
            driver.find_element_by_xpath(self.edit_name).send_keys(Keys.CONTROL + "a", Keys.DELETE)
            self.enterText("xpath", self.edit_name, name)
            print("Name is Entered")
        except Exception:
            print("Exception in Entering Name Method")
            self.screenshot.attach_screenshot_to_allure_report("Entering Name Method")
            raise Exception
    ...
    def enter_basic_info_edit_birthday(self, birthday):
        try:
            ...
            driver.find_element_by_xpath(self.edit_birthday).send_keys(Keys.CONTROL + "a", Keys.DELETE)
            self.enterText("xpath", self.edit_birthday, birthday)
            print("Birthday is Entered")
        except Exception:
            print("Exception in Entering Birthday Method")
            self.screenshot.attach_screenshot_to_allure_report("Entering Birthday Method")
            raise Exception
    ...
    def click_save_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking the Save Button Method")
            raise Exception
    ...
    def click_save_dependent(self):
        try:
            ...
            driver.find_element_by_xpath(self.save_dependent).click()
            print("Save Button is Clicked")
            sleep(2)
        except Exception:
            print("Exception in Clicking the Save Button Method")
    ...
    def enter_secondary_email(self, email_id):
        try:
            ...
            driver.find_element_by_xpath(self.secondary_email_edit).send_keys(Keys.CONTROL + "a", Keys.DELETE)
            time.sleep(2)
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Secondary Email Address Method")
            raise Exception
    ...
    def enter_edit_phone_number(self, phone):
        try:
            ...
            driver.find_element_by_xpath(self.edit_phone_number).send_keys(Keys.CONTROL + "a", Keys.DELETE)
            time.sleep(2)
    ...
    def click_additional_profile_information(self):
        try:
            ...
            element = driver.find_element_by_xpath(self.additional_profile_information_tb)
            driver.execute_script("arguments[0].click();", element)
            print("Additional Profile Information is clicked")
        except Exception:
            print("Exception in Clicking Additional Profile Information Method")
            self.screenshot.attach_screenshot_to_allure_report("Clicking Additional Profile Information Method")
            raise Exception
    ...
    def enter_edit_sex(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Gender Method")
            raise Exception
    ...
    def select_race(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Race Method")
            raise Exception
    ...
    def select_ethnicity(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Ethnicity Method")
            raise Exception
    ...
    def enter_edit_age(self, gen):
        try:
            ...
            driver.find_element_by_xpath(self.edit_age).send_keys(Keys.CONTROL + "a", Keys.DELETE)
            self.enterText("xpath", self.edit_age, gen)
            print("Age is entered")
        except Exception:
            print("Exception in Entering Age Method")
            self.screenshot.attach_screenshot_to_allure_report("Entering Age Method")
            raise Exception
    ...
    def enter_edit_name_add_info(self, name):
        try:
            ...
            driver.find_element_by_xpath(self.name_edit_add_info).send_keys(Keys.CONTROL + "a", Keys.DELETE)
    ...
    def enter_edit_birthday_add_info(self, dob):
        try:
            ...
            driver.find_element_by_xpath(self.edit_birthday_add_info).send_keys(Keys.CONTROL + "a", Keys.DELETE)
    ...
    def click_notification_preferences(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Notification Preferences Button Method")
            raise Exception
    ...
    def click_enable_email_notifications(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Email Toggle Bar Method")
            raise Exception
    ...
    def click_enable_sms_notifications(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking SMS Toggle Bar Method")
            raise Exception
    ...
    def click_enable_push_notifications(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Push Notifications Toggle Bar Method")
            raise Exception
    ...
    def click_auto_approvals_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Auto Approvals Button Method")
            raise Exception
    ...
    def click_dependents_add_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Add Dependents Button Method")
            raise Exception
    ...
    def enter_dependent_name(self, name):
        try:
            ...
            dependent = driver.find_element_by_xpath(self.dependent_name)
            dependent.send_keys(name)
            time.sleep(2)
        except Exception:
            print("Exception in Entering Dependent Name Method")
            self.screenshot.attach_screenshot_to_allure_report("Entering Dependent Name Method")
            raise Exception
    ...
    def click_dependent_birthday(self, dob):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Dependent Date of Birth Method")
            raise Exception
    ...
    def Verify_dependent(self):
        verify_d = driver.find_element_by_xpath(self.verify_dependent).text
        print(verify_d)
    ...
    def click_dependent_account_details(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Dependent Account Details Button Method")
            raise Exception
    ...
    def click_delete_dependent(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Delete Dependent Account Button Method")
            raise Exception
    ...
    def verify_dependent_delete(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Verifying Delete Dependent Account Method")
            raise Exception
    ...
    def click_basic_info_edit_dependent(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Dependent Basic Info Edit Button Method")
            raise Exception
    ...
    def enter_name_dependent(self, name):
        try:
            ...
            # # driver.find_element_by_xpath(self.name_dependent).send_keys(Keys.CONTROL + "a", Keys.DELETE)
            # self.enterText("xpath", self.name_dependent, name)
            # print("Dependent Name is edited")
            global dependent_fullname
            self.clickElement("xpath", self.name_dependent)
            driver.find_element_by_xpath(self.name_dependent).send_keys(Keys.CONTROL + "a", Keys.DELETE)
            dependent = driver.find_element_by_xpath(self.name_dependent)
            dependent.send_keys(name)
            time.sleep(2)
    ...
    def enter_dob_dependent(self, dob):
        try:
            ...
            driver.find_element_by_xpath(self.dob_dependent).send_keys(Keys.CONTROL + "a", Keys.DELETE)
    ...
    def click_add_info_dependent(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Additional Profile Information Button Method")
            raise Exception
    ...
    def click_add_info_dependent_edit(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Dependent Additional Info Edit Button Method")
            raise Exception
    ...
    def enter_add_info_dependent_gender(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Dependent Gender Method")
            raise Exception
    ...
    def enter_add_info_dependent_age(self, age):
        try:
            ...
            driver.find_element_by_xpath(self.add_info_dependent_age).send_keys(Keys.CONTROL + "a", Keys.DELETE)
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Dependent Age Method")
            raise Exception
    ...
    def enter_add_info_dependent_name(self, name):
        try:
            ...
            driver.find_element_by_xpath(self.add_info_dependent_name).send_keys(Keys.CONTROL + "a", Keys.DELETE)
    ...
    def click_sign_out_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Sign Out Button Method")
            raise Exception
    ...
    def click_sign_out_confirm_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Sign Out Confirmation Button Method")
            raise Exception
    ...
    def click_reset_password_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Reset Password Button Method")
            raise Exception
    ...
    def click_confirm_reset_password_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Reset Password Confirmation Method")
            raise Exception
    ...
    def click_delete_account_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Delete Account Button Method")
            raise Exception
    ...
    def click_confirm_delete_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Delete Account Confirmation Button Method")
            raise Exception
    ...
    def click_request_my_data_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Request My Data Button Method")
            raise Exception
    ...
    def click_call_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Call Button Method")
            raise Exception
    ...
    def enter_username(self, username):
        try:
            ...
            driver.find_element_by_xpath(self.username_textbox).send_keys(username)
            print("Username is Entered")
        except Exception:
            print("Exception in Entering Username Method")
            self.screenshot.attach_screenshot_to_allure_report("Entering Username Method")
            raise Exception
    ...
    def enter_login_password(self, password):
        try:
            ...
            driver.find_element_by_xpath(self.password_textbox).send_keys(password)
            print("Password is entered")
        except Exception:
            print("Exception in Entering Password Method")
            self.screenshot.attach_screenshot_to_allure_report("Entering Password Method")
    ...
    def click_continue_signin(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Signin Method")
            raise Exception
    ...
    def select_service_category_virtual_appointment(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Service Category Virtual Appointment Method")
            raise Exception
    ...
    def select_service_type_virtual_appointment(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Service Type Virtual Appointment Method")
            raise Exception
    ...
    def select_service_category_medical(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Service Category Medical Method")
            raise Exception
    ...
    def select_service_category_vaccination(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Service Category Vaccination Method")
            raise Exception
    ...
    def select_service_type_antibody(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Service Type Antibody Method")
            raise Exception
    ...
    def select_service_type_antigen(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Service Type Antigen Method")
            raise Exception
    ...
    def select_service_type_pcr(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Service Type PCR Method")
            raise Exception
    ...
    def select_service_type_vaccine(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Service Type Vaccine Method")
            raise Exception
    ...
    def click_issuer_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Issuer")
            raise Exception
    ...
    def select_issuer_any(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Issuer type Any Method")
            raise Exception
    ...
    def select_issuer_cvs_pharmacy(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Issuer type CVC Pharmacy Method")
            raise Exception
    ...
    def select_issuer_inspire_health(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Issuer type Inspire Health")
            raise Exception
    ...
    def select_issuer_virtual_inspire_health(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Select Issuer type Inspire Health Method")
            raise Exception
    ...
    def select_choose_appointment_date_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Appointment Date Method")
            raise Exception
    ...
    def click_find_slot(self):
        try:
            element = driver.find_element_by_xpath(self.find_a_slot)
            driver.execute_script("arguments[0].click();", element)
            sleep(1)
            print("Find a Slot button is clicked")
        except Exception:
            LOGGER.info("Exception in Clicking Find a Slot Method")
            self.screenshot.attach_screenshot_to_allure_report("Clicking Find a Slot Method")
            raise Exception
    ...
    def select_appointment_slot(self):
        try:
            gettext = driver.find_element_by_xpath(self.book_slot).text
            ...
            self.screenshot.attach_screenshot_to_allure_report("Select Appointment Slot Method")
            raise Exception

    def select_reschedule_appointment_slot(self):
        try:
            gettext = driver.find_element_by_xpath(self.book_slot)
            if gettext == "No appointments available":
                self.clickElement("xpath", self.schedule_date_next)
                sleep(2)
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Appointment Slot Method")
            raise Exception
    ...
    def select_confirm_appointment_slot(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("confirm Appointment slot")
            raise Exception
    ...
    def click_review_all_details(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Review All Details Method")
            raise Exception
    ...
    def click_confirm_appointment(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Confirm Appointment Method")
            raise Exception
    ...
    def verify_appointment_scheduled(self):
        try:
            ...
            actual = driver.find_element_by_xpath(self.appointment_scheduled_message).text
            ...
            self.screenshot.attach_screenshot_to_allure_report("Verifying Appointment Method")
            raise Exception
    ...
    def verify_dependent_appointment_scheduled(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Verify Appointment Method")
            raise Exception
    ...
    def click_your_info_btn(self):
        try:
            sleep(3)
            page_down = driver.find_element_by_tag_name('html')
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking your information button")
            raise Exception
    ...
    def click_next(self):
        try:
            ...
            element = driver.find_element_by_xpath(self.next_btn)
            driver.execute_script("arguments[0].click();", element)
            sleep(1)
            print("Next button is clicked")
        except Exception:
            LOGGER.info("Exception in Click Next method")
            self.screenshot.attach_screenshot_to_allure_report("click next")
            raise Exception
    ...
    def click_schedule_appointment(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("clicking schedule an new appointment")
            raise Exception
    ...
    def click_schedule(self):
        try:
            ...
            element = driver.find_element_by_xpath(self.schedule_btn)
            driver.execute_script("arguments[0].click();", element)
            print("Schedule button is clicked")
        except Exception:
            LOGGER.info("Exception in Click schedule method")
            self.screenshot.attach_screenshot_to_allure_report("click schedule")
            raise Exception
    ...
    def click_scheduled_appointment(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click scheduled Appointment")
            raise Exception
    ...
    def click_scheduled_appointment_dependent(self):
        try:
            view = driver.find_element_by_xpath(self.view_dependent_appointment)
    ...
    def click_cancel_scheduled_appointment(self):
        try:
            ...
            # assert 'Profile' in title
            print("Title of the page:", title)
            element = driver.find_element_by_xpath(self.cancel_appointment)
            driver.execute_script("arguments[0].click();", element)
            ...
            self.screenshot.attach_screenshot_to_allure_report("click cancel Appointment")
            raise Exception
    ...
    def verify_cancel_scheduled_appointment(self):
        try:
            ...
            actual = driver.find_element_by_xpath(self.verify_cancel_appointment_message).text
            print(actual)
            ...
            self.screenshot.attach_screenshot_to_allure_report("Verifying cancel Appointment")
            raise Exception
    ...
    def click_dependent_scheduled_appointment(self):
        try:
            sleep(5)
            gettext = driver.find_element_by_xpath(self.dependent_schedule_appointment).text
            if gettext == "You have not scheduled any appointments yet":
                element = driver.find_element_by_xpath(self.dependent_schedule_appointment_1)
                driver.execute_script("arguments[0].click();", element)
            else:
                element = driver.find_element_by_xpath(self.dependent_schedule_appointment_1)
                driver.execute_script("arguments[0].click();", element)
    ...
    def enter_additional_questions(self):
        try:
            ...
            # self.clickElement("xpath", self.covid_test_yes)
            self.element_Is_Visible("xpath", self.covid_test_yes)
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Additional Details Method")
            raise Exception
    ...
    def enter_allergies(self, name):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Enter Allergies Method")
            raise Exception
    ...
    def enter_address(self, name):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Address Method")
            raise Exception
    ...
    def click_appointments(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click appointments")
            raise Exception
    ...
    def click_home_kit_order(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Home Kit Order Method")
            raise Exception
    ...
    def click_start_order(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Start Order Button")
            raise Exception
    ...
    def select_antigen_test(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Antigen Test method")
            raise Exception
    ...
    def select_antibody_test(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Antibody Test method")
            raise Exception
    ...
    def select_antigen_self_kit(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Antigen Self Test method")
            raise Exception
    ...
    def click_check_out(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Check Out button method")
            raise Exception
    ...
    def enter_shipping_fullname(self, name):
        try:
            ...
            sleep(1)
            driver.find_element_by_xpath(self.shipping_fullname).clear()
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Fullname method")
            raise Exception
    ...
    def enter_shipping_phone_number(self, phone):
        try:
            ...
            driver.execute_script("arguments[0].click();", element)
            sleep(1)
            driver.find_element_by_xpath(self.shipping_phone_number).clear()
    ...
    def enter_shipping_address(self, address):
        try:
            ...
            driver.execute_script("arguments[0].click();", element)
            sleep(1)
            driver.find_element_by_xpath(self.shipping_address).clear()
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Shipping Address method")
            raise Exception
    ...
    def click_order_next(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Next button method")
            raise Exception
    ...
    def enter_card_number(self, number):
        try:
            ...
            print("Title of the page:", title)
            a = driver.find_element_by_xpath(self.submit)
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Card Number method")
            raise Exception
    ...
    def enter_expiry_date(self, number):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering Expiry Date method")
            raise Exception
    ...
    def enter_cvc(self, number):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Entering CVC number method")
            raise Exception
    ...
    def click_submit(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Clicking Submit Button method")
            raise Exception
    ...
    def verify_order_(self):
        try:
            ...
            verify = driver.find_element_by_xpath(self.verify_order).text
    ...
    def get_unique_id(self):
        try:
            ...
            Unique_id = driver.find_element_by_xpath(self.unique_id).text
            print(Unique_id)
            self.data.write_data_into_excel1(2, 2, Unique_id)
            return Unique_id
        except Exception:
            print("Exception in Get Unique Id method")
            self.screenshot.attach_screenshot_to_allure_report("Get Unique Id method")
            raise Exception
    ...
    def click_notification_bell_icon(self):
        try:
            ...
            element = driver.find_element_by_xpath(self.notification_bell_icon)
            driver.execute_script("arguments[0].click();", element)
            print("Notification Bell Icon is clicked")
        except Exception:
            print("Exception in Clicking Notification Bell Icon method")
            self.screenshot.attach_screenshot_to_allure_report("Clicking Notification Bell Icon method")
            raise Exception
    ...
    def click_see_request(self):
        try:
            ...
            element = driver.find_element_by_xpath(self.see_request)
            driver.execute_script("arguments[0].click();", element)
            print("See Request Button is clicked")
        except Exception:
            print("Exception in Clicking See Request Button method")
            self.screenshot.attach_screenshot_to_allure_report("Clicking See Request Button method")
            raise Exception
    ...
    def click_approve_once(self):
        try:
            ...
            element = driver.find_element_by_xpath(self.approve_once)
            driver.execute_script("arguments[0].click();", element)
            print("Approve Once Button is clicked")
        except Exception:
            print("Exception in Clicking Approve Once Button method")
            self.screenshot.attach_screenshot_to_allure_report("Clicking Approve Once Button method")
            raise Exception
    ...
    def click_hamburger_icon(self):
        try:
            ...
            driver.find_element_by_xpath(self.hamburger_icon).click()
            sleep(2)
            print("Click hamburger button")
        except Exception:
            print("Exception in clicking hamburger icon method")
            self.screenshot.attach_screenshot_to_allure_report("click hamburger icon")
            raise Exception
    ...
    def click_reset_id(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click reset U-Pass id")
            raise Exception
    ...
    def click_view_scan_history(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click view scan history")
            raise Exception
    ...
    def click_download_qr_code(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Download QR code")
            raise Exception
    ...
    def click_get_care(self):
        try:
            ...
            print("Title of the page:", title)
            driver.find_element_by_xpath(self.get_care_btn).click()
            sleep(5)
            print("Get care button is clicked")
        except Exception:
            LOGGER.info("Exception in get care method")
            self.screenshot.attach_screenshot_to_allure_report("click get care")
            raise Exception
    ...
    def click_places_btn(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click places")
            raise Exception
    ...
    def click_search_bar(self, search):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click search bar")
            raise Exception
    ...
    def click_shs_students_program(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click shs students program")
            raise Exception
    ...
    def click_shs_athletics_program(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click shs athletics program")
            raise Exception
    ...
    def select_favourite_program(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select favourite program")
            raise Exception
    ...
    def unselect_favourite_program(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("unselect favourite program")
            raise Exception
    ...
    def click_requirements(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click requirements button")
            raise Exception
    ...
    def verify_health_tb(self):
        try:
            ...
            health_tb = driver.find_element_by_xpath(self.verify_health).text
            print(health_tb)
            ...
            self.screenshot.attach_screenshot_to_allure_report("Verify health tab under requirements page")
            raise Exception
    ...
    def click_records(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click records")
            raise Exception
    ...
    def click_add_or_get_record(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click add or get record")
            raise Exception
    ...
    def click_scan_document(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click scan document")
            raise Exception
    ...
    def click_scan_code(self):
        try:
            scan = driver.find_element_by_xpath(self.scan_code_btn)
            driver.execute_script("arguments[0].click();", scan)
            print("Scan code button clicked successfully")
        except Exception:
            LOGGER.info("Exception in click scan code method")
            self.screenshot.attach_screenshot_to_allure_report("click scan code")
            raise Exception
    ...
    def click_to_link_record(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click to link record")
            raise Exception
    ...
    def select_holder_name(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Select holder name")
            raise Exception
    ...
    def select_record_category_health(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_category_health")
            raise Exception
    ...
    def select_record_type_covid_pcr(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_type_covid_pcr")
            raise Exception
    ...
    def select_record_type_covid_vaccination(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_type_covid_vaccination")
            raise Exception
    ...
    def select_record_type_covid_19_test_antigen(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_type_covid__19_test_antigen")
            raise Exception
    ...
    def select_record_type_immunization(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_type_immunization")
            raise Exception
    ...
    def select_record_type_covid_19_test_antibody(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_type_covid_19_test_anitbody")
            raise Exception
    ...
    def select_record_type_covid_19_rt_pcr(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_type_covid_19_rt_pcr")
            raise Exception
    ...
    def select_issuer_type_cdc(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select issuer type cdc")
            raise Exception
    ...
    def select_issuer_type_inspire_health(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select issuer type inspire health")
            raise Exception
    ...
    def select_issuer_type_inspire_health_1(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select issuer type inspire health 1")
            raise Exception
    ...
    def select_record_category_id(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_category_id")
            raise Exception
    ...
    def select_record_type_driver_license(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_type_driver_license")
            raise Exception
    ...
    def select_record_type_employee_id_card(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_type_employee_id_card")
            raise Exception
    ...
    def select_record_type_passport(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_type_passport")
            raise Exception
    ...
    def select_record_type_student_id_card(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_record_type_student_id_card")
            raise Exception
    ...
    def select_issuer_type_texas(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select issuer type texas for driver license")
            raise Exception
    ...
    def select_issuer_type_alabama(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select issuer type albama for driver license")
            raise Exception
    ...
    def select_issuer_type_alaska(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select issuer type alaska for driver license")
            raise Exception
    ...
    def select_issuer_for_employee(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_issuer_for_employee")
            raise Exception
    ...
    def select_issuer_for_student(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_issuer_for_student")
            raise Exception
    ...
    def select_issuer_for_passport(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select_issuer_for_passport")
            raise Exception
    ...
    def click_to_scan_code_button(self):
        try:
            scan_code = driver.find_element_by_xpath(self.scan_code_button)
            driver.execute_script("arguments[0].click();", scan_code)
        except Exception:
            print("Exception in scan button for records method")
            self.screenshot.attach_screenshot_to_allure_report("click scan button")
            raise Exception
    ...
    def click_to_scan_button(self):
        try:
            scan = driver.find_element_by_xpath(self.scan)
            driver.execute_script("arguments[0].click();", scan)
            sleep(2)
            ...
            self.screenshot.attach_screenshot_to_allure_report("click_the_scan_code")
            raise Exception
    ...
    def click_search_records(self):
        try:
            search = driver.find_element_by_xpath(self.search_records)
            driver.execute_script("arguments[0].click();", search)
            print("Search records button clicked")
        except Exception:
            print("Exception in click search records method")
            self.screenshot.attach_screenshot_to_allure_report("click search records")
            raise Exception
    ...
    def click_confirm(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Click confirm method")
            raise Exception
    ...
    def click_save_button(self):
        try:
            save = driver.find_element_by_xpath(self.click_save)
            driver.execute_script("arguments[0].click();", save)
            sleep(2)
            print("Save button clicked successfully")
        except Exception:
            print("Exception in click save button method")
            self.screenshot.attach_screenshot_to_allure_report("Click save button method")
            raise Exception
    ...
    def click_save_record(self):
        try:
            save = driver.find_element_by_xpath(self.save_record_btn)
            driver.execute_script("arguments[0].click();", save)
            print("Clicked save record button")
            sleep(2)
        except Exception:
            print("Exception in click_save_record method")
            self.screenshot.attach_screenshot_to_allure_report("click_save_record")
            raise Exception
    ...
    def click_use_existing_record(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click use existing record")
            raise Exception
    ...
    def upload_document(self, path):
        try:
            document = driver.find_element_by_xpath(self.use_existing_btn)
    ...
    def click_health_tb(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click health tab")
            raise Exception
    ...
    def click_id_tb(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click ID tab")
            raise Exception
    ...
    def verify_covid_pcr_test(self):
        try:
            ...
            covid_pcr_test = driver.find_element_by_xpath(self.verify_record_type_covid_pcr_test).text
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify covid pcr test record")
            raise Exception
    ...
    def verify_covid_vaccination(self):
        try:
            ...
            covid_vaccination = driver.find_element_by_xpath(self.verify_record_type_covid_vaccination).text
            print(covid_vaccination)
            if covid_vaccination == test_data["validation"]["covid vaccination"] or test_data["validation"]["covid vaccination1"]:
                assert True
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify covid vaccination record")
            raise Exception
    ...
    def verify_covid_19_test_antigen(self):
        try:
            ...
            verify = driver.find_element_by_xpath(self.verify_record_type_covid_19_antigen).text
            print(verify)
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify covid 19 test antigen record")
            raise Exception
    ...
    def verify_immunization(self):
        try:
            ...
            verify = driver.find_element_by_xpath(self.verify_record_type_immunization).text
            print(verify)
            if verify == test_data["validation"]["health immunization"] or test_data["validation"]["health immunization1"]:
                assert True
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify immunization record")
            raise Exception
    ...
    def verify_covid_19_test_antibody(self):
        try:
            ...
            verify = driver.find_element_by_xpath(self.verify_record_type_covid_19_antibody).text
            print(verify)
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify covid 19 test antibody record")
            raise Exception
    ...
    def verify_covid_19_rt_pcr(self):
        try:
            ...
            verify = driver.find_element_by_xpath(self.verify_record_type_covid_19_rt_pcr).text
            print(verify)
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify covid 19 rt-pcr test record")
            raise Exception
    ...
    def verify_passport_record(self):
        try:
            ...
            verify = driver.find_element_by_xpath(self.verify_record_type_passport).text
            print(verify)
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify passport record record")
            raise Exception
    ...
    def verify_texas_driver_license_record(self):
        try:
            ...
            verify = driver.find_element_by_xpath(self.verify_record_type_texas_driver_license).text
            print(verify)
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify texas driver license record")
            raise Exception
    ...
    def verify_alabama_driver_license_record(self):
        try:
            ...
            verify = driver.find_element_by_xpath(self.verify_record_type_alabama_driver_license).text
            print(verify)
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify alabama driver license record")
            raise Exception
    ...
    def verify_alaska_driver_license_record(self):
        try:
            ...
            verify = driver.find_element_by_xpath(self.verify_record_type_alaska_driver_license).text
            print(verify)
            if verify == test_data["validation"]["alabama license"]:
                assert True
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify alaska driver license record")
            raise Exception
    ...
    def verify_student_id_card_record(self):
        try:
            ...
            verify = driver.find_element_by_xpath(self.verify_record_type_student_id_card).text
            print(verify)
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify student id card record record")
            raise Exception
    ...
    def select_health_record(self):
        try:
            ...
            print("visible")
            a = driver.find_element_by_xpath(self.select_record)
            if a.is_displayed():
            ...
            self.screenshot.attach_screenshot_to_allure_report("clicking Health record")
            raise Exception
    ...
    def click_delete_from_u_pass(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click Delete from U-Pass button")
            raise Exception
    ...
    def click_delete_record(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click delete record")
            raise Exception
    ...
    def verify_delete_message(self):
        try:
            ...
            delete = driver.find_element_by_xpath(self.verify_delete_record).text
            print(delete)
            ...
            self.screenshot.attach_screenshot_to_allure_report("verify delete message")
            raise Exception
    ...
    def click_drop_down_from_records(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("click dropdown from records")
            raise Exception
    ...
    def select_the_dependent(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("select the dependent")
            raise Exception
    ...
    def select_dependent_holder_name(self):
        try:
            ...
            self.screenshot.attach_screenshot_to_allure_report("Selecting Dependent Holder Name Method")
            raise Exception
